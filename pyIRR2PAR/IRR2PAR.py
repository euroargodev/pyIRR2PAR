...
def IRR2PAR(Ed, z):
    ...
    JPitarch_PAR, JPitarch_PAR_b, JPitarch_ep50, JPitarch_IQR_ep = JPitarch_PAR_from_Ed(Ed, z)
    ...
    mean_uncertainty = np.where(
        ...
        np.where(
            ...
            (JTan_e + JPitarch_e) / 2  # If neither is NaN, use  LPU (Low of Propagation of Uncertainties ) method assuming full correlation
        )
    )
...
#
# # Appel de la fonction IRR2PAR
# JTan_PAR_results, JPitarch_PAR_results, mean_PAR, mean_uncertainty = IRR2PAR(Ed, z)
#
#
#
# # Affichage des résultats
# print("Résultats de JTan_PAR_results :", JTan_PAR_results)
# print("Résultats de JPitarch_PAR_results :", JPitarch_PAR_results)
# print("Vecteur moyen (mean_par + PAR) :", mean_PAR)
# print([mean_PAR,mean_uncertainty])
